...
namespace Call
{
    public class ConstantValue : MonoBehaviour
    {
        ...
        //マウスとの差分座標
        public const float DIFF_X = 150.0f;
        public const float DIFF_Y = -75.0f;

        //カメラ
        public const float CAM_DISTANCE = 4500.0f;
        public static readonly Vector3 CAM_POS = new Vector3(680.0f, 2050.0f, 1800.0f); //位置
        public static Vector3 CAM_ROT = new Vector3(90.0f, 0.0f, 0.0f); //真上の角度
